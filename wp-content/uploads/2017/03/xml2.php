...
$stmt = $db->prepare("SELECT name, address, lat, lng, ( 3959 * acos( cos( radians(?) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians(?) ) + sin( radians(?) ) * sin( radians( lat ) ) ) ) AS distance FROM mosques HAVING distance < ? ORDER BY distance LIMIT 0 , 20");
